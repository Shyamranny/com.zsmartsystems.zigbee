 ...
 *
 */
public class ZigBeeConsoleClearBindCommand extends ZigBeeConsoleAbstractCommand {
    @Override
    ...
    public String getDescription() {
        return "Clear Binding table a device";
    }
    ...
    public void process(ZigBeeNetworkManager networkManager, String[] args, PrintStream out)
        ...
        ZigBeeCommand zigBeeCommand = new ZigBeeCommand();
